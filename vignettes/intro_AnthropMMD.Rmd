...
* Finally, a p-value (for non-nullity of each MMD value) is given by the composant `$MMDpval`. Theoretical details for this test of significance can be found in @Souza77.
