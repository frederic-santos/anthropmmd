...
It is not necessary for the `Trait`s to be manually converted as factors. `toyMMD` includes nine traits with many missing values, and the individuals belong to five groups:
